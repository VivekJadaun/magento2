<?php
  namespace Vinsol\MultiVendorMarketplace\Block\Adminhtml\Vendors;
  ...
  class Edit extends \Magento\Backend\Block\Widget\Form\Container {
    ...
    protected function _construct()
    {
      ...
      parent::_construct();
      if ($this->_isAllowedAction('Vinsol_MultiVendorMarketplace::vendors_new')) {
      ...
      public function getHeaderText() {
        if ($this->_coreRegistry->registry('vendor')->getId()) {
          return __("Edit Vendor '%1'", $this->escapeHtml($this->_coreRegistry->registry('vendor')->getId()));
        } else {
