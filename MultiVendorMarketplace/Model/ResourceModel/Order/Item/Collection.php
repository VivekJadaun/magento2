<?php
namespace Vinsol\MultiVendorMarketplace\Model\ResourceModel\Order\Item;
...
class Collection extends \Magento\Sales\Model\ResourceModel\Order\Item\Collection
{
    ...
    const JOIN_TABLE = \Magento\Catalog\Model\Product::ENTITY . '_entity_text';
    ...
    public function _initSelect()
    {
        ...
        if ($this->appState->getAreaCode() == 'adminhtml') {
            if (($currentUser->getRole()->getRoleName() == self::VENDOR_ROLE_GROUP) && $currentUser->getIsActive()) {
                ...
                $this->getSelect()
                    ->join(self::JOIN_TABLE, 'product_id = entity_id')
